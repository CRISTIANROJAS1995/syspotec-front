...
@Component({
    selector       : 'syspotec-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : syspotecAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SyspotecVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'syspotec-vertical-navigation-item-collapsed': this.isCollapsed,
            'syspotec-vertical-navigation-item-expanded' : this.isExpanded
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._syspotecVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._syspotecVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._syspotecVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._syspotecVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: SyspotecNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: SyspotecNavigationItem, item: SyspotecNavigationItem): boolean
    {

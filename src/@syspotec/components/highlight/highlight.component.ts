...
import { SyspotecHighlightService } from '@syspotec/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[syspotec-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'syspotecHighlight'
})
export class SyspotecHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _syspotecHighlightService: SyspotecHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._syspotecHighlightService.highlight(this.code, this.lang));

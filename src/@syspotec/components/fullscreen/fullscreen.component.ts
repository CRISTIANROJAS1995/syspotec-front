...
import { FSDocument, FSDocumentElement } from '@syspotec/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'syspotec-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'syspotecFullscreen'
})
export class SyspotecFullscreenComponent implements OnInit
{

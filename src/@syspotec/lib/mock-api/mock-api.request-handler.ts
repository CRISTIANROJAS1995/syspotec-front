...
import { SyspotecMockApiReplyCallback } from '@syspotec/lib/mock-api/mock-api.types';

export class SyspotecMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: SyspotecMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: SyspotecMockApiReplyCallback): void
    {
        // Store the reply

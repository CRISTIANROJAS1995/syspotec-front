...
import { SyspotecMockApiService } from '@syspotec/lib/mock-api/mock-api.service';

@Injectable({
    providedIn: 'root'
})
export class SyspotecMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        ...
        private _syspotecMockApiService: SyspotecMockApiService
    )
    {
    }
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>
    {
        ...
        const {
                  handler,
                  urlParams
              } = this._syspotecMockApiService.findHandler(request.method.toUpperCase(), request.url);

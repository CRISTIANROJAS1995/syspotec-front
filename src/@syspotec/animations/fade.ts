...
import { SyspotecAnimationCurves, SyspotecAnimationDurations } from '@syspotec/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${SyspotecAnimationDurations.entering} ${SyspotecAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${SyspotecAnimationDurations.exiting} ${SyspotecAnimationCurves.acceleration}`
                }
            }
        )
    ]
